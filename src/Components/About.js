        ...
        <div className='aboutData'>
          ...
          <div className='barLengthAboutMe'><h3 className={props.bg?'aboutHeadingW':'aboutHeadingB'}>About Me</h3></div>
            <div className='aboutInfo'>
              <p>Hey, I'm Etisha, a 20 year old currently pursuing B.E. in Computer Science.
              ...
              <a href='https://drive.google.com/file/d/1hH35qUMrek-190lsznkSvCUsbGjSwNex/view?usp=drive_link' target='__blank' className='resume'>Resume</a>
            </div>
          </div>
