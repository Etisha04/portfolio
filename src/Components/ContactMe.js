         ...
         <div className='contCont'>
          <div className={props.bg?'contInfoW':'contInfoB'}>
            <div className='contCard'>
              ...
              <a href="mailto:etishapednekar@gmail.com" className='contBtn' target="__blank">
            ...
            <div className='contCard'>
              ...
              <div className='contNameDir'>
              <a href="https://x.com/Etisha04" className='contBtn' target="__blank">
              <span className='contCardData'>etisha04</span>
                <i className='bx bx-right-arrow-alt contact__button-icon'></i>
              </a>
              </div>
            </div>
